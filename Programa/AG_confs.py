...
# ---------------------------
POP_SIZE = 800           # Número de individuos en la población
...
MUTATION_PROB = 2 / 20  # Probabilidad de mutar cada gen
ETA_MUT = 0.001                         # Índice de distribución para mutación polinomial
