...
# ---------------------------
POP_SIZE = 500           # Número de individuos en la población
NUM_GENERATIONS = 1000     # Número de generaciones
...
TOURNAMENT_SIZE = 5  # Número de individuos participantes en cada torneo

# Parámetros del cruzamiento SBX
CROSSOVER_PROB = 0.9  # Probabilidad de aplicar cruzamiento
ETA_C = 0.01            # Índice de distribución para SBX
...
ETA_MUT = 0.01                         # Índice de distribución para mutación polinomial
